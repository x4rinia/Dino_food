-- ==============================================================================
-- Dino_food Migration: Einkaufsliste, Gerichte, Favoriten & Vorrat
-- Datei: supabase/migrations/dino_food_shopping_dishes_favorites.sql
-- ==============================================================================

-- 1. Helper-Funktion für Haushaltszugehörigkeit
...
-- 8. Realtime Publikationen sicherstellen
DO $$
BEGIN
