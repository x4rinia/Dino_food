-- ==============================================================================
-- Dino_food Migration: Gerichte, Vorrat, Favoriten & Fixes
-- Datei: supabase/migrations/dino_food_update_stock_dishes.sql
-- ==============================================================================

-- 1. Sicherstellen, dass Helper-Funktion existiert
...
-- 2. Fix Foreign Key auf profiles für shopping_items
DO $$
BEGIN
    IF EXISTS (
...
-- 3. Gerichte-Tabellen anlegen (falls noch nicht vorhanden)
...
-- Spalte is_locked hinzufügen (falls dishes bereits existierte)
ALTER TABLE public.dishes 
    ADD COLUMN IF NOT EXISTS is_locked BOOLEAN NOT NULL DEFAULT false;

-- RLS Policies für dishes
...
-- 4. Zutaten für Gerichte (dish_items)
...
-- 5. Favoriten für Gerichte pro Benutzer
...
-- 6. Vorrat pro Haushalt (household_stock)
...
-- 7. Realtime Publikation für Vorrat
DO $$
BEGIN
